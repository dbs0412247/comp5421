...
const string BASE_DIR = "/home/adrian/Desktop/cvpr10Data/";
...
int main() {
	...
	*/
	...
	convertLabelToImage(labelSetEval, 0, 320*240, test3);
	convertLabelToImage(labelSetTrain, 0, 320*240, test4);
	imshow("test1", test1);
	imshow("test2", test2);
	imshow("test3", test3);
	imshow("test4", test4); waitKey();
	return 0;
}
